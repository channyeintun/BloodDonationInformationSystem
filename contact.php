...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Blood Bank &amp; <br>Say Ta Nar Medical, <br>
					73/38 ,Cherry Street,<br>
					Mdy-3010.<br>
					Sandar Dt.
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: +959402512110</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="#" >info@onlinebdis.org</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: 24*7</p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website">W</abbr>: <a href="index.php">www.onlinebdis.org.mm</a></p>
