...
<ul class="nav nav-stacked">
	...
	<hr>
	<li><a href="admin_report.php"><i class="fa fa-pie-chart" aria-hidden="true"></i> Need Blood Report </a></li>
	<hr>
	<li><a href="#add" data-toggle="collapse" ><i class="fa fa-cogs fa-lg"></i> Settings</a></li>
	<ul class="nav collapse" id="add">
		<li><a href="admin_chpw.php"><i class="fa fa-pencil-square-o"></i> Edit Password</a></li>
