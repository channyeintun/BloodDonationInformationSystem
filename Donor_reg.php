                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						  ...
						  <div class="form-group">
								<label class="control-label text-primary" for="PINCODE">NRC</label>
                                <input type="text" required name="PINCODE" id="PINCODE" class="form-control" placeholder="Insert NRC Number">
                          </div>
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						 						<input type="text"  name="VOLUNTARY_GROUP" id="VOLUNTARY_GROUP"  class="form-control" placeholder="Voluntary Group Name">
						 </div>
						<div class="form-group">
